...
{#if $showReauthModal}
  <Modal on:close={enableOfflineMode} dialogClass="bg-neutral-900 text-gray-200 border border-gray-700 rounded shadow-2xl">
...
{#if $showOfflineConfirmationModal}
  <Modal on:close={() => showOfflineConfirmationModal.set(false)} dialogClass="bg-neutral-900 text-gray-200 border border-gray-700 rounded shadow-2xl">
...
{#if $showConflictModal}
  <Modal on:close={closeConflictModal} dialogClass="bg-neutral-900 text-gray-200 border border-gray-700 rounded shadow-2xl">
