...
export const SPELLS: SpellInfo[] = [
  ...
  },
  {
    ...
    tier: 1,
    duration: { type: "Focus", amt: 0 },
    desc: "You assume the physical appearance of a humanoid you have seen. Your stats and abilities do not change.",
  },
  {
    name: "Beast Sight",
    range: "Near",
    ...
    tier: 1,
    duration: { type: "Focus", amt: 0 },
    desc: "You can see and hear through the senses of a beast you can see. You are blind and deaf to your own surroundings while doing so.",
  },
  {
    name: "Blood Bond",
    range: "Close",
    ...
    tier: 1,
    duration: { type: "Day", amt: 1 },
    desc: "You drink a drop of a creature's blood. For the duration, you know its exact distance and direction from you.",
  },
  {
    name: "Hex",
    range: "Near",
    ...
    desc: "A creature you can see has disadvantage on checks with one stat of your choice.",
  },
  {
    name: "Speak with Dead",
    range: "Close",
    ...
    tier: 2,
    duration: { type: "Round", amt: 10 },
    desc: "You awaken a corpse and can ask it up to three questions. It retains the knowledge it had in life and answers truthfully, but cryptically.",
  },
  {
    name: "Blight",
    range: "Near",
    ...
    tier: 2,
    duration: { type: "Instant", amt: 0 },
    desc: "A living creature takes 3d8 damage. Plant creatures take double damage.",
  },
  {
    name: "Scry",
    range: "Unlimited",
    ...
    tier: 3,
    duration: { type: "Focus", amt: 0 },
    desc: "You can see and hear a creature you have met before as if you were standing next to it. The target has a vague sense of being watched.",
  },
  {
    name: "Prophecy",
    range: "Self",
    ...
    tier: 1,
    duration: { type: "Instant", amt: 0 },
    desc: "You foresee a glimpse of the immediate future. The GM will give you a useful clue about what will happen if you take a specific action.",
  },
  {
    name: "Guidance",
    range: "Close",
    ...
    tier: 1,
    duration: { type: "Round", amt: 10 },
    desc: "The target gains advantage on their next attack or stat check.",
  },
  {
    name: "Read Runes",
    range: "Close",
    ...
    tier: 1,
    duration: { type: "Instant", amt: 0 },
    desc: "You instantly comprehend the meaning of any magical or mundane writing you can see.",
  },
  {
    ...
    tier: 2,
    duration: { type: "Day", amt: 1 },
    desc: "Up to 5 creatures you touch can breathe underwater for the duration.",
  },
  {
    ...
    class: "Seer",
    tier: 2,
    duration: { type: "Day", roll: { numDice: 1, diceType: "d4" } },
    desc: "The target begins drowning in invisible water. They take 1d6 damage per round unless they pass a CON check to cough up the water.",
  },
  {
    name: "Summon Storm",
    range: "Far",
    class: "Seer",
    tier: 3,
    duration: { type: "Hour", roll: { numDice: 1, diceType: "d4" } },
    desc: "You call forth a raging tempest. High winds, heavy rain, and lightning strike the area, making flight impossible and extinguishing fires.",
  },
  {
    name: "Divination",
    range: "Self",
    ...
    tier: 3,
    duration: { type: "Instant", amt: 0 },
    desc: "You ask the Old Gods a single question. The GM answers with a short phrase, a cryptic poem, or a clear vision.",
  },
  // --- Cursed Scroll 4 (River of Night): Druid/Neutral Wizard Spells ---
  {
    name: "Breath (Wizard N)",
    range: "Self",
    class: "Wizard",
    tier: 1,
    duration: { type: "Round", amt: 10 },
  ...
  {
    name: "Treeshape (Wizard N)",
    range: "Self",
    class: "Wizard",
    tier: 3,
    duration: { type: "Round", amt: 10 },
    desc: "You and your gear turn into a treant with the below stats for the spell's duration. You do not have the treant's Animate Tree talent. You cannot cast spells while under the effect of this spell. You retain your INT, WIS, and CHA stats. AC 14, HP 38, ATK 2 slam +8 (1d12) or 1 rock (far) +8 (2d6), MV near, S +4, D -1, C +2, I *, W *, Ch *, AL N, LV 8",
  },
  {
    name: "Mycelium (Wizard N)",
    range: "Self",
    class: "Wizard",
    tier: 4,
    duration: { type: "Instant", amt: 0 },
  ...
  // --- Cursed Scroll 5: Sorcerer/Chaotic Wizard Spells ---
  {
    name: "Blight (Wizard C)",
    range: "Self",
    class: "Wizard",
    tier: 1,
    duration: { type: "Round", amt: 5 },
  ...
  {
    name: "Protection From Good (Wizard C)",
    range: "Close",
    class: "Wizard",
    tier: 1,
    duration: { type: "Focus", amt: 0 },
  ...
  {
    name: "Mazzim's Mesmerism (Wizard C)",
    range: "Near",
    class: "Wizard",
    tier: 3,
    duration: { type: "Focus", amt: 0 },
  ...
  // --- Cursed Scroll 6 (City of Masks): Mage/Lawful Wizard Spells ---
  {
    name: "Cleanse (Wizard L)",
    range: "Close",
    class: "Wizard",
    tier: 1,
    duration: { type: "Instant", amt: 0 },
  ...
  {
    name: "Speak With Object (Wizard L)",
    range: "Close",
    class: "Wizard",
    tier: 3,
    duration: { type: "Instant", amt: 0 },
