...
export const CLASS_TALENTS: { [key in Class]: Talent[] } = {
  ...
  Bard: [
    {
      name: "You have ADV on downtime checks (excluding carousing)",
      type: "generic",
      min: 2,
      max: 2,
    },
    {
      name: "+1 to melee and ranged attacks or +1 to Fascinate rolls",
      type: "chooseBonus",
      min: 3,
      max: 6,
      choices: [
        ...
        [
          {
            name: "+1 to Fascinate rolls",
            desc: "+1 to Fascinate rolls",
            type: "modifyAmt",
            bonusTo: "spellcastRoll",
            bonusSource: "Talent",
            bonusAmount: 1,
            editable: true,
            metadata: { type: "spell", spell: "Fascinate" },
          },
        ],
      ] as (Bonus | Bonus[])[],
    },
    ...
    {
      name: "Add +2 to your group's carousing event rolls",
      type: "generic",
      min: 10,
      max: 11,
    },
  ...
  Wyrdling: [
    ...
    {
      name: "+2 to Strength, Dexterity, or Charisma stats",
      type: "chooseBonus",
      min: 3,
      max: 6,
      choices: [
    ...
    {
      name: "Gain a new Corruption talent",
      type: "generic",
      min: 7,
      max: 9,
    },
    {
      name: "Gain +1 to attacks and damage rolls with your pseudopod",
      type: "bonus",
      min: 10,
      max: 11,
      bonuses: [
        {
          name: "+1 to attacks with pseudopod",
          desc: "+1 to attack rolls with pseudopod",
          type: "modifyAmt",
          bonusTo: "attackRoll",
          bonusSource: "Talent",
          bonusAmount: 1,
          editable: true,
          metadata: { type: "weapon", weapon: "Pseudopod" },
        },
        {
          name: "+1 to damage with pseudopod",
          desc: "+1 to damage rolls with pseudopod",
          type: "modifyAmt",
          bonusTo: "damageRoll",
          bonusSource: "Talent",
          bonusAmount: 1,
  ...
  "Basilisk Warrior": [
    {
      name: "You find a basilisk egg; a loyal hatchling emerges in 1d4 days",
      type: "generic",
      min: 2,
      max: 2,
    },
