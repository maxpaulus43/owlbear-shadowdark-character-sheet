export default [
  ...
  },
  {
    ...
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.nMFsp1aA3r3DY6xq" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1679220549339,
      modifiedTime: 1679220622805,
      lastModifiedBy: "EKVggA45fx6fzkCK",
    },
    folder: null,
    sort: 0,
  ...
  },
  {
    ...
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.cjt1zht61fuzGH0i" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
  ...
  },
  {
    ...
    command:
      '// Macro to draw for encounter in The Lost Citadel and only show it to the GM.\n\nconst pack = game.packs.get("shadowdark.rollable-tables");\n\nconst tableID = pack.index.find(o => o.name === "The Lost Citadel: Random Encounter Check")._id;\nconst table = await pack.getDocument(tableID);\nawait table.draw({ rollMode: CONST.DICE_ROLL_MODES.PRIVATE});',
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.FhoSe3L8mU7NUg8S" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1679224316438,
      modifiedTime: 1679224668057,
      lastModifiedBy: "EKVggA45fx6fzkCK",
    },
    folder: null,
    sort: 0,
    _id: "C0TN1X2LOAPYWJmD",
  },
  {
    ...
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.PZwIy632EjEaQwzO" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1679228806586,
      modifiedTime: 1679228875976,
      lastModifiedBy: "EKVggA45fx6fzkCK",
    },
    folder: null,
    sort: 0,
  ...
  },
  {
    ...
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.TzdXiZT4I3XOTi2h" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1679220653370,
      modifiedTime: 1679220684423,
      lastModifiedBy: "EKVggA45fx6fzkCK",
    },
    folder: null,
    sort: 0,
  ...
  },
  {
    ...
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.3Ql21Njzj6Jh3uil" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1679229436526,
      modifiedTime: 1679229476073,
      lastModifiedBy: "EKVggA45fx6fzkCK",
    },
    folder: null,
    sort: 0,
  ...
  },
  {
    ...
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.xF0pBEdiw6Ry25N0" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1679220625994,
      modifiedTime: 1679220650825,
      lastModifiedBy: "EKVggA45fx6fzkCK",
    },
    folder: null,
    sort: 0,
  ...
  {
    name: "Light Tracker UI Toggle (GM Only)",
    type: "script",
    scope: "global",
    author: "EjRYV38yldItTITy",
    ...
    flags: { core: { sourceId: "Macro.SEh88OBTmU29lKPV" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1678988401175,
      modifiedTime: 1679067739305,
      lastModifiedBy: "EjRYV38yldItTITy",
    },
    folder: null,
    sort: 0,
    ownership: { default: 0, EjRYV38yldItTITy: 3 },
    _id: "VgfWt2xWzYJyVMbA",
  },
  {
    name: "Draw Hazard",
    type: "script",
  ...
  {
    name: "Roll Random Beastmen NPC",
    type: "script",
    scope: "global",
    author: "EKVggA45fx6fzkCK",
    img: "icons/environment/creatures/gargoyle-grey-blue.webp",
    command:
    ...
    ownership: { default: 0, EKVggA45fx6fzkCK: 3 },
    flags: { core: { sourceId: "Macro.UniJEcpooNtvqWSw" } },
    _stats: {
      systemId: "shadowdark",
      systemVersion: "0.1.0",
      coreVersion: "10.291",
      createdTime: 1679218799258,
      modifiedTime: 1679228874622,
      lastModifiedBy: "EKVggA45fx6fzkCK",
    },
    folder: null,
    sort: 0,
    _id: "zNYDtS7XcT3IaQ4t",
  },
];
